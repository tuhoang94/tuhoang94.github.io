...
// setup x 
var xValue = function(d) { return d["Happiness.Score"];}, // data -> value
    xScale = d3.scale.linear().range([0, width-200]), // value -> display
    xMap = function(d) { return xScale(xValue(d));}, // data -> display
    xAxis = d3.svg.axis().scale(xScale).orient("bottom");

// setup y
var yValue = function(d) { return d["Happiness.Rank"];}, // data -> value
...
//    console.log(d);
  ...
  svg.selectAll(".dot")
    ...
    .enter().append("circle")
      ...
      //alert(d["Country"] + ", Score: " + xValue(d) + ", Rank: " + yValue(d));
          tooltip.transition()
               .duration(200)
               .style("opacity", .9);
          tooltip.html(d["Country"] + "<br/> (" + xValue(d) 
	        + ", " + yValue(d) + ")")
               ...
               .style("top", (d3.event.pageY - 5040) + "px");
      })
